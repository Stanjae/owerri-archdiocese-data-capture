...
const LogoGrid = () => (
    <SectionWrapper>
        <div className="custom-screen">
            <h2 className="font-semibold text-sm text-foreground text-center">
                Trusted by the largest companies
            </h2>
            <div className="mt-8 flex justify-center">
                <ul className="inline-grid text-foreground grid-cols-2 gap-x-10 gap-y-8 md:gap-x-16 md:grid-cols-3 lg:grid-cols-4">
                    {
                        logos.map((item, idx) => (
                            <li key={idx}>
