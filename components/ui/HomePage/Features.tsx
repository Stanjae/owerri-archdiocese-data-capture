...
import DarkWrapper from '../Clientwrappers/DarkWrapper'
...
const Features = () => {
    ...
    return (
        <DarkWrapper id="features">
            <div className="custom-screen text-background/60 justify-between gap-24 lg:flex">
                <div className="max-w-xl">
                    <h2 className="text-background text-3xl font-semibold sm:text-4xl">
                    ...
                    <ul className="grid gap-8 sm:grid-cols-2">
                        {
                            features.map((item, idx) => (
                                <li key={idx} className="flex gap-x-4">
                                    <div className="flex-none w-12 h-12 bg-foreground/70 text-owarchGreen rounded-lg flex items-center justify-center">
                                        {item.icon}
                                    </div>
                                    <div>
                                        <h4 className="text-lg text-background/90 font-semibold">
                                            {item.title}
                                        </h4>
                                        <p className="mt-3">
                                            {item.desc}
