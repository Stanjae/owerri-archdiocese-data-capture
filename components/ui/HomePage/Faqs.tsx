        ...
        <div className="custom-screen text-gray-600">
            <div className="max-w-xl xl:mx-auto xl:text-center">
                ...
                <p className="mt-3">
                    ...
                    <a
                        className='text-owarchGreen hover:text-green-400 duration-150 font-semibold whitespace-nowrap'
                        href='#'>
                        contact us
                    </a>.
                </p>
            ...
            <div className='mt-12'>
                <ul className='space-y-8 gap-12 grid-cols-2 sm:grid sm:space-y-0 lg:grid-cols-3'>
                    {faqsList.map((item, idx) => (
                        ...
                        >
                            <summary
                                className="flex items-center justify-between font-semibold text-gray-700 dark:text-foreground/90">
                                {item.q}
                            </summary>
                            <p
